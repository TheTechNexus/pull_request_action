...
var import_is_plain_object = __nccwpck_require__(558);
...
var import_is_plain_object = __nccwpck_require__(9062);
...
const pull_request_1 = __nccwpck_require__(5338);
const telegram_1 = __nccwpck_require__(535);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pull_request = yield (0, pull_request_1.getPullRequestDetails)({
            owner,
            repo,
        ...
        if (telegram_bot_token && telegram_chat_id && pull_request) {
            (0, telegram_1.pingTelegramOnPullRequest)({
                telegram_bot_token,
                telegram_chat_id,
                pull_request,
            });
        }
        const labels = yield (0, pull_request_1.getLabelsFromFileName)({
            owner,
            repo,
            pull_number: +pull_number,
        ...
        yield (0, pull_request_1.updatePullRequestLables)({
            owner,
            repo,
            pull_number: +pull_number,
            labels: labels,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updatePullRequestLables = exports.getLabelsFromFileName = exports.getPullRequestDetails = void 0;
const fs = __importStar(__nccwpck_require__(7147));
function getPullRequestDetails({ owner, repo, pull_number, octokit, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getLabelsFromFileName({ owner, repo, pull_number, branch_name, octokit, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data: pullRequestFiles } = yield octokit.rest.pulls.listFiles({
            owner,
            repo,
            pull_number,
        });
...
exports.getLabelsFromFileName = getLabelsFromFileName;
function updatePullRequestLables({ owner, repo, pull_number, labels, octokit, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.updatePullRequestLables = updatePullRequestLables;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.pingTelegramOnPullRequest = void 0;
const axios_1 = __importDefault(__nccwpck_require__(8757));
function pingTelegramOnPullRequest({ telegram_bot_token, telegram_chat_id, pull_request, }) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        if ((_b = (_a = pull_request === null || pull_request === void 0 ? void 0 : pull_request.user) === null || _a === void 0 ? void 0 : _a.login) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes("dependabot[bot]")) {
            return;
        }
        if ((_c = pull_request === null || pull_request === void 0 ? void 0 : pull_request.title) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes("wip")) {
            return;
        }
        const sendMessage = [];
        sendMessage.push(`🔥 New Pull Request Alert! 🔥`);
        sendMessage.push(`Project: ${(_d = pull_request === null || pull_request === void 0 ? void 0 : pull_request.base) === null || _d === void 0 ? void 0 : _d.repo.name}`);
        sendMessage.push(`Title: ${pull_request === null || pull_request === void 0 ? void 0 : pull_request.title}`);
        sendMessage.push(`Author: ${pull_request === null || pull_request === void 0 ? void 0 : pull_request.user.login}`);
        let reviewers = "Reviewers: ";
        for (const reviewer of pull_request.requested_reviewers) {
            reviewers += reviewer.login + ", ";
        }
        sendMessage.push(reviewers);
        sendMessage.push(`Link: ${pull_request === null || pull_request === void 0 ? void 0 : pull_request.html_url}`);
        const telegramText = sendMessage.join("\n");
        const telegramApiUrl = `https://api.telegram.org/bot${telegram_bot_token}/sendMessage?chat_id=${telegram_chat_id}&text=${encodeURIComponent(telegramText)}`;
        axios_1.default.get(telegramApiUrl);
    });
}
exports.pingTelegramOnPullRequest = pingTelegramOnPullRequest;
